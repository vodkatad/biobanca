...
#res_path<-'/scratch/trcanmed/biobanca/dataset/V1/LOH_earlylate/nosense_loh_plot/seg_dim_100000'
...
a<-pheatmap(result, cluster_rows = FALSE, cluster_cols = FALSE, annotation_col = an_col, 
         show_colnames = FALSE, legend_breaks = c(0,1,2,3,4), color = colorRampPalette(c("grey", "black", "red","blue","turquoise"))(5),
         legend_labels = c("NO","LOH_diff","only_early","common","BAD BED"),gaps_col = gappini2$segment_id, gaps_row = righini) #,
