...
write.table(res, file = "/scratch/trcanmed/biobanca/dataset/V1/trans_sign/expr/clinical_data_for_circos_wderivation_revision.tsv", quote = FALSE, sep = "\t", col.names = TRUE, row.names = FALSE)
